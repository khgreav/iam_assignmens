...
;============================= START ==============
; k ∧ l ∧ m ∧ k in (1,8) ∧ l in (1,8) ∧ m in (1,8) ∧ q(k,l) ∧ k+m in (1,8) ∧ l+m in (1,8) ∧ !q(k+m, l+m)
(assert (forall ((k Int)) (forall ((l Int)) (forall ((m Int)) (=> (and (and (and (and (and (is-in-range k) (is-in-range l) (is-in-range m) ) ) (pos k l)) (is-in-range (+ k m) ) ) (is-in-range(+ l m) ) ) (not (pos (+ k m) (+ l m) ) ) )      ))))
(assert (forall ((k Int)) (forall ((l Int)) (forall ((m Int)) (=> (and (and (and (and (and (is-in-range k) (is-in-range l) (is-in-range m) ) ) (pos k l)) (is-in-range (- k m) ) ) (is-in-range(- l m) ) ) (not (pos (- k m) (- l m) ) ) )      ))))
(assert (forall ((k Int)) (forall ((l Int)) (forall ((m Int)) (=> (and (and (and (and (and (is-in-range k) (is-in-range l) (is-in-range m) ) ) (pos k l)) (is-in-range (+ k m) ) ) (is-in-range(- l m) ) ) (not (pos (+ k m) (- l m) ) ) )      ))))
(assert (forall ((k Int)) (forall ((l Int)) (forall ((m Int)) (=> (and (and (and (and (and (is-in-range k) (is-in-range l) (is-in-range m) ) ) (pos k l)) (is-in-range (- k m) ) ) (is-in-range(+ l m) ) ) (not (pos (- k m) (+ l m) ) ) )      ))))
;============================= END ================
